#!/bin/bash
# Builds Standalone HOMME on the SRN Capacity Cluster 'Flight'.
...
### Ensure the work space files exist
mkdir -p ${WORK_ROOT}
mkdir -p ${WORK_E3SM}
mkdir -p ${WORK_HOMME}
...
case "${TEST_ID}" in
	dcmip2012_1_1)
		...
		MODE=preqx
		WORK_TEST=${WORK_DCMIP}/dcmip2012_test1.1_3d_deformational_flow/${MODE}
		;;
	dcmip2012_1_2)
		TEST_NAME='DCMIP 2012 Test 1.2 - Hadley-Like Meridional Circulation'
		MODE=preqx
		WORK_TEST=${WORK_DCMIP}/dcmip2012_test1.2_hadley_meridional_circulation/${MODE}
		;;
	dcmip2012_1_3)
		TEST_NAME='DCMIP 2012 Test 1.3 - Thin Clouds Over Orography'
		MODE=preqx
		WORK_TEST=${WORK_DCMIP}/dcmip2012_test1.3_thin_clouds_over_orography/${MODE}
		;;
	dcmip2012_2_0)
		TEST_NAME='DCMIP 2012 Test 2.0 - Steady State with Orography'
		MODE=theta-l
		WORK_TEST=${WORK_DCMIP}/dcmip2012_test2.0_steady_state_with_orography/${MODE}
		;;
	dcmip2012_2_1)
		TEST_NAME='DCMIP 2012 Test 2.1 - Non-Sheared Background Flow with Orography'
		MODE=theta-l
		WORK_TEST=${WORK_DCMIP}/dcmip2012_test2.1_nh_mountain_waves_no_shear/${MODE}
		;;
	dcmip2012_2_2)
		TEST_NAME='DCMIP 2012 Test 2.2 - Sheared Background Flow with Orography'
		MODE=theta-l
		WORK_TEST=${WORK_DCMIP}/dcmip2012_test2.2_nh_mountain_waves_with_shear/${MODE}
		;;
	dcmip2012_3)
		TEST_NAME='DCMIP 2012 Test 3 - Non-Hydrostatic Gravity Waves'
		MODE=theta-l
		WORK_TEST=${WORK_DCMIP}/dcmip2012_test3.1_nh_gravity_waves/${MODE}
		;;
	dcmip2012_4_1)
		TEST_NAME='DCMIP 2012 Test 4.1 - Baroclinic Instability'
		MODE=theta-l
		WORK_TEST=${WORK_DCMIP}/dcmip2012_test4.1_baroclinic_instability/${MODE}
		;;
	dcmip2016_1)
		TEST_NAME='DCMIP 2016 Test 1 - Moist Baroclinic Wave'
		MODE=theta-l
		WORK_TEST=${WORK_DCMIP}/dcmip2016_test1_baroclinic_wave/${MODE}
		;;
	dcmip2016_2)
		TEST_NAME='DCMIP 2016 Test 2 - Tropical Cyclone'
		MODE=theta-l
		WORK_TEST=${WORK_DCMIP}/dcmip2016_test2_tropical_cyclone/${MODE}
		;;
	dcmip2016_3)
		TEST_NAME='DCMIP 2016 Test 3 - Supercell'
		MODE=theta-l
		WORK_TEST=${WORK_DCMIP}/dcmip2016_test3_supercell/${MODE}
		;;
	*)
...
cd ${WORK_HOMME}
cmake -C ${MACHINE_FILE} ${SRC_HOMME}
make -j ${MODE}
