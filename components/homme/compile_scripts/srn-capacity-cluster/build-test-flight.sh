...
### Set CMake flags
if [[ "${MODE}" == "sweqx" ]]; then
	CMAKE_FLAGS+=" -DBUILD_HOMME_SWEQX=TRUE -DBUILD_HOMME_PREQX=FALSE -DBUILD_HOMME_PREQX_ACC=FALSE -DBUILD_HOMME_THETA=FALSE -DBUILD_HOMME_THETA_KOKKOS=FALSE -DBUILD_HOMME_SWIM=FALSE -DBUILD_HOMME_TOOL=FALSE"
elif [[ "${MODE}" == "preqx" ]]; then
	CMAKE_FLAGS+=" -DBUILD_HOMME_SWEQX=FALSE -DBUILD_HOMME_PREQX=TRUE -DBUILD_HOMME_PREQX_ACC=FALSE -DBUILD_HOMME_THETA=FALSE -DBUILD_HOMME_THETA_KOKKOS=FALSE -DBUILD_HOMME_SWIM=FALSE -DBUILD_HOMME_TOOL=FALSE"
elif [[ "${MODE}" == "theta-l" ]]; then
	CMAKE_FLAGS+=" -DBUILD_HOMME_SWEQX=FALSE -DBUILD_HOMME_PREQX=FALSE -DBUILD_HOMME_PREQX_ACC=FALSE -DBUILD_HOMME_THETA=TRUE -DBUILD_HOMME_THETA_KOKKOS=FALSE -DBUILD_HOMME_SWIM=FALSE -DBUILD_HOMME_TOOL=FALSE"
elif [[ "${MODE}" == "preqx_acc" ]]; then
	CMAKE_FLAGS+=" -DBUILD_HOMME_SWEQX=FALSE -DBUILD_HOMME_PREQX=FALSE -DBUILD_HOMME_PREQX_ACC=TRUE -DBUILD_HOMME_THETA=FALSE -DBUILD_HOMME_THETA_KOKKOS=FALSE -DBUILD_HOMME_SWIM=FALSE -DBUILD_HOMME_TOOL=FALSE"
elif [[ "${MODE}" == "theta-l_kokkos" ]]; then
	CMAKE_FLAGS+=" -DBUILD_HOMME_SWEQX=FALSE -DBUILD_HOMME_PREQX=FALSE -DBUILD_HOMME_PREQX_ACC=FALSE -DBUILD_HOMME_THETA=FALSE -DBUILD_HOMME_THETA_KOKKOS=TRUE -DBUILD_HOMME_SWIM=FALSE -DBUILD_HOMME_TOOL=FALSE"
elif [[ "${MODE}" == "swim" ]]; then
	CMAKE_FLAGS+=" -DBUILD_HOMME_SWEQX=FALSE -DBUILD_HOMME_PREQX=FALSE -DBUILD_HOMME_PREQX_ACC=FALSE -DBUILD_HOMME_THETA=FALSE -DBUILD_HOMME_THETA_KOKKOS=FALSE -DBUILD_HOMME_SWIM=TRUE -DBUILD_HOMME_TOOL=FALSE"
fi
