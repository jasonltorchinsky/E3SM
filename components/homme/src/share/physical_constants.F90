...
module physical_constants
  ...
  real (kind=longdouble_kind), public, parameter :: QQ_PI   = 3.141592653589793238462643383279_longdouble_kind
  real (kind=real_kind), public, parameter :: rearth0       = 6.376D6    ! Mean equatorial radius of Earth [m]
  ...
  real (kind=real_kind), public, parameter :: omega0        = 7.292D-5   ! Rotation rate of Earth [radians s^{-1}]
  real (kind=real_kind), public            :: omega         = omega0
  real (kind=real_kind), public, parameter :: Rgas          = 287.04D0   ! Gas constant for dry air [J kg^{-1} K^{-1}]
  real (kind=real_kind), public, parameter :: Cp            = 1005.0D0   ! Specific heat of dry air at constant pressure [J kg^{-1} K^{-1}]
  real (kind=real_kind), public, parameter :: p0            = 100000.0D0 ! Reference pressure for hybrid-sigma coordinate [Pa]
  real (kind=real_kind), public, parameter :: MWDAIR        = 28.966D0
  real (kind=real_kind), public, parameter :: Rwater_vapor  = 461.50D0   ! Gas constant for water vapor [J kg^{-1} K^{-1}]
  real (kind=real_kind), public, parameter :: Cpwater_vapor = 1870.0D0   ! Specific heat of water vapor at constant pressure [J kg^{-1} K^{-1}]
