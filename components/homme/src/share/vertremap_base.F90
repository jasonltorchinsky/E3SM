...
!! vert_remap_q_alg == 2  means mean 1st order reconstruction in ghost cells
!! vert_remap_q_alg == 10 linear extrapolation with global bounds preservation
!! vert_remap_q_alg == 11 linear extrapolation (unbounded)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
function compute_ppm( a , dx, remap_alg )    result(coefs)
  ...
  integer(kind=int_kind), intent(in) :: remap_alg             !Ghost cell options
  ...
  integer :: j
  integer :: indB, indE
  ! For vert_remap_q_alg=2, use 1st order reconstruction in the specified number of layers near the model top and surface
  integer(kind=int_kind) :: vert_remap_tom = 1
  integer(kind=int_kind) :: vert_remap_bl = 1
...
!=============================================================================================!
  ...
  subroutine linextrap(dx1,dx2,dx3,dx4,y1,y2,y3,y4,limit,lo,hi)
    ...
    integer(kind=int_kind), intent(in) :: limit
